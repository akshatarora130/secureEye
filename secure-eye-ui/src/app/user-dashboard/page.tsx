        ...
        <header className="flex justify-between items-center mb-12">
          ...
          <div className="space-x-4">
            <Button
              ...
              className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg transition-all duration-300"
            >
            ...
            <Button
              ...
              variant="outline"
              className="text-blue-300 border-blue-400 hover:bg-blue-900/50 hover:text-blue-200 transition-all duration-300"
            >
              Apply for Subsidy
            </Button>
          </div>
              ...
              <CardFooter className="flex justify-between">
                ...
                <div className="space-x-2">
                  <Button
                    variant="outline"
                    size="sm"
                    className="text-yellow-300 border-yellow-400 hover:bg-yellow-900/50 hover:text-yellow-200 transition-all duration-300"
                  >
          ...
          <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700 mt-8 shadow-lg">
            ...
            <CardContent>
              <p className="text-gray-300">
                You haven't added any cameras yet. Click the "Add New Camera"
