		...
		<div className='min-h-screen bg-gray-900 flex flex-col justify-center items-center px-4'>
			<div className='max-w-md w-full space-y-8'>
				<div>
					...
					<h2 className='mt-6 text-center text-3xl font-extrabold text-white'>CamSafe Admin</h2>
					<p className='mt-2 text-center text-sm text-gray-400'>Enter your admin passkey to access the dashboard</p>
				</div>
				<form
				...
				<div className='text-center text-sm text-gray-400'>Forgot your passkey? Contact the system administrator.</div>
			</div>
		</div>
	);
}
