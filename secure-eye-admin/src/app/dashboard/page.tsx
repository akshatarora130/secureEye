    ...
    <div className='flex h-screen bg-gray-950 text-gray-100'>
      ...
      >
        ...
        <nav className='mt-5 px-2'>
          <a
            className='flex items-center px-4 py-2 text-indigo-100 bg-indigo-800 rounded-lg transition-all duration-200 hover:bg-indigo-700 hover:scale-105'
            href='#'
          >
          ...
          <a
            className='flex items-center px-4 py-2 mt-2 text-gray-300 hover:bg-gray-800 hover:text-indigo-100 rounded-lg transition-all duration-200 hover:scale-105'
            href='#'
          >
        ...
        <header className='flex items-center justify-between px-6 py-4 bg-gray-900'>
          <div className='flex items-center'>
            <button
              ...
              className='text-gray-300 focus:outline-none lg:hidden hover:text-indigo-100 transition-colors duration-200'
            >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6'>
            ...
            <Card className='bg-gray-900 border-gray-800 hover:border-purple-500 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/50 group'>
              <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                ...
                <Users className='h-4 w-4 text-purple-400 group-hover:text-purple-300 transition-colors duration-300' />
              </CardHeader>
              <CardContent>
            ...
            <CardContent>
              <div className='aspect-video bg-gray-800 rounded-md flex items-center justify-center relative overflow-hidden group'>
                ...
                <div className='absolute inset-0 flex items-center justify-center'>
                  <MapPin className='w-16 h-16 text-indigo-500 animate-pulse group-hover:scale-110 transition-all duration-300' />
                </div>
                  ...
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      ...
                      <Button
                        size='sm'
                        variant='outline'
                        className='ml-auto text-indigo-100 border-indigo-500 hover:bg-indigo-700 transition-colors duration-300'
                      >
                        View
                      </Button>
                    </div>
                  ...
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      ...
                      <Button
                        size='sm'
                        variant='outline'
                        className='ml-auto text-yellow-100 border-yellow-500 hover:bg-yellow-700 transition-colors duration-300'
                      >
                        Review
                      </Button>
                    </div>
